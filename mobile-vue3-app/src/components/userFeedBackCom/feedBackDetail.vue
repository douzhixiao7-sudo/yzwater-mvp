        ...
        <div class="content-layer">
            <div class="paddingContent">
                ...
                <div class="feedBackDetailCard" v-if="detailData">
                    <!-- <div class="itemTitle">
                        <span class="type-badge" v-if="detailData.referenceType">{{ getReferenceTypeBadgeLabel(detailData.referenceType) }}</span>
                    ...
                    <!-- 问题描述模块（参考 feedBackSuccess.vue section-2） -->
                    <div class="section-2">
                    ...
                    <!-- 反馈文件模块（参考 feedBackSuccess.vue section-3） -->
                    <div class="section-3">
                    ...
                    <!-- 问题点位模块（参考 feedBackSuccess.vue section-4） -->
                    <div class="section-4">
...
export default {
    ...
    methods: {
        ...
        getProblemProgress() {
            //根据反馈id查询问题进展
            this.$http.get(`/app-api/problem/feedback/${this.detailData.id}`).then(res => {
        ...
        getStatusColor(status) {
            // status: 0-待审核(待受理), 1-已驳回, 2-已受理, 3-与 2 同展示为已受理, 4-已办结(已办理)
            const colorMap = {
                0: '#FF5100',  // 待受理
                1: '#999999',  // 已驳回
                2: '#349DFF',  // 已受理
                3: '#349DFF',  // 原待核验，展示为已受理
                4: '#3CB298'   // 已办理
            };
...
.feedBack-detail-container {
    ...
    .content-layer {
        ...
        padding-bottom: calc(40px + env(safe-area-inset-bottom)); // 适配底部安全区域
