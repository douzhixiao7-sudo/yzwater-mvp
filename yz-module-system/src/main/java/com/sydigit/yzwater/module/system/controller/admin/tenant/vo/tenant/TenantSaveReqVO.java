package com.sydigit.yzwater.module.system.controller.admin.tenant.vo.tenant;
...
public class TenantSaveReqVO {
    ...
    @Schema(description = "租户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "lijun")
