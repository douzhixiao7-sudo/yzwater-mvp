package com.sydigit.yzwater.module.system.controller.admin.dept.vo.dept;
...
public class DeptSaveReqVO {
    ...
    @Schema(description = "部门名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "lijun")
    ...
    @Schema(description = "邮箱", example = "yz@iocoder.cn")
