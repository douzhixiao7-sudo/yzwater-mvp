...
import com.sydigit.yzwater.module.system.framework.sms.core.enums.SmsChannelEnum;
...
public class SmsCallbackController {
    ...
    @PermitAll
    @TenantIgnore
    @Operation(summary = "飞鸽短信的回调", description = "参见 doc/飞鸽短信.md 文档")
    public CommonResult<Boolean> receiveFeigeSmsStatus(@RequestBody String requestBody) throws Throwable {
        smsSendService.receiveSmsStatus(SmsChannelEnum.FEIGE.getCode(), requestBody);
        return success(true);
    }
