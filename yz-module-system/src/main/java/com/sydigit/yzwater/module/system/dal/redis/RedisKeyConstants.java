package com.sydigit.yzwater.module.system.dal.redis;
...
public interface RedisKeyConstants {
     ...
     * 字典数据列表缓存
     * <p>
     * KEY 格式：dict_data_list:{dictType}
     * VALUE 数据类型：String（JSON）字典数据列表
     * <p>
     * 注意：该缓存用于高频读取场景（例如 /river/channel/dict），有效期 1 天；
     * 当字典数据新增/修改/删除时，会同步刷新对应 dictType 的缓存。
     */
    String DICT_DATA_LIST = "dict_data_list:%s";
