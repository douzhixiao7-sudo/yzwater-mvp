package com.sydigit.yzwater.module.bpm.controller.admin.definition.vo.form;
...
public class BpmFormSaveReqVO {
    ...
    @Schema(description = "表单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "lijun")
