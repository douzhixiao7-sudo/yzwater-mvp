package com.sydigit.yzwater.module.bpm.service.task;
...
import com.sydigit.yzwater.framework.common.util.date.DateUtils;
import com.sydigit.yzwater.framework.common.util.json.JsonUtils;
import com.sydigit.yzwater.framework.common.util.object.ObjectUtils;
import com.sydigit.yzwater.framework.common.util.object.PageUtils;
import com.sydigit.yzwater.framework.datapermission.core.annotation.DataPermission;
import com.sydigit.yzwater.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.sydigit.yzwater.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.sydigit.yzwater.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.sydigit.yzwater.module.bpm.controller.admin.task.vo.instance.*;
import com.sydigit.yzwater.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.sydigit.yzwater.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.sydigit.yzwater.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.sydigit.yzwater.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.sydigit.yzwater.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.sydigit.yzwater.module.bpm.enums.ErrorCodeConstants;
import com.sydigit.yzwater.module.bpm.enums.definition.BpmModelTypeEnum;
import com.sydigit.yzwater.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.sydigit.yzwater.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.sydigit.yzwater.module.bpm.enums.task.BpmReasonEnum;
import com.sydigit.yzwater.module.bpm.enums.task.BpmTaskStatusEnum;
import com.sydigit.yzwater.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.sydigit.yzwater.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.sydigit.yzwater.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.sydigit.yzwater.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.sydigit.yzwater.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.sydigit.yzwater.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.sydigit.yzwater.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.sydigit.yzwater.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.sydigit.yzwater.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.sydigit.yzwater.module.bpm.service.definition.BpmProcessDefinitionService;
import com.sydigit.yzwater.module.bpm.service.message.BpmMessageService;
...
import static com.sydigit.yzwater.framework.common.util.collection.CollectionUtils.*;
import static com.sydigit.yzwater.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.sydigit.yzwater.module.bpm.enums.ErrorCodeConstants.*;
import static com.sydigit.yzwater.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.sydigit.yzwater.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/yz-cloud/issues/ID1UYA
