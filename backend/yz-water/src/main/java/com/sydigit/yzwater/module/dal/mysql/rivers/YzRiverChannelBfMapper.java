 ...
 */
@Mapper
public interface YzRiverChannelBfMapper extends BaseMapperX<YzRiverChannelBfDO> {

    @Update({
            "<script>",
            "update yz_river_channel_bf",
    ...
    int updateEditFieldsById(@Param("entity") YzRiverChannelBfDO entity);

    default LambdaQueryWrapper<YzRiverChannelBfDO> buildQueryWrapper(RiverChannelPageReqVO reqVO) {
        return new LambdaQueryWrapper<YzRiverChannelBfDO>()
                .like(reqVO.getRiverCode() != null && !reqVO.getRiverCode().isEmpty(),
                        YzRiverChannelBfDO::getRiverCode, reqVO.getRiverCode())
                .like(reqVO.getRiverName() != null && !reqVO.getRiverName().isEmpty(),
                        YzRiverChannelBfDO::getRiverName, reqVO.getRiverName())
                .in(reqVO.getRiverLevel() != null && !reqVO.getRiverLevel().isEmpty(),
                        YzRiverChannelBfDO::getRiverLevel, reqVO.getRiverLevel())
                .eq(reqVO.getEcologyType() != null && !reqVO.getEcologyType().isEmpty(),
                        YzRiverChannelBfDO::getEcologyType, reqVO.getEcologyType())
                .eq(reqVO.getIsProvincialBackbone() != null,
                        YzRiverChannelBfDO::getIsProvincialBackbone, reqVO.getIsProvincialBackbone())
    ...
    List<YzRiverChannelBfDO> selectListByTown(@Param("areaCode") String areaCode);
    ...
    List<YzRiverChannelBfDO> selectAllRiverList();
    ...
    List<YzRiverChannelBfDO> selectRiverListByTowns(@Param("areaCodes") String[] areaCodes);
}
