 ...
 */
@Mapper
public interface YzWaterReservoirMapper extends BaseMapperX<YzWaterReservoirDO> {
    ...
    @Update({
            ...
            "  join yz_water_facility_base b on b.id = r.facility_id",
    ...
    default LambdaQueryWrapper<YzWaterReservoirDO> buildQueryWrapper(ReservoirPageReqVO reqVO) {
        LambdaQueryWrapper<YzWaterReservoirDO> wrapper = new LambdaQueryWrapper<YzWaterReservoirDO>()
                .like(StrUtil.isNotBlank(reqVO.getReservoirCode()),
                        YzWaterReservoirDO::getReservoirCode, reqVO.getReservoirCode())
                .like(StrUtil.isNotBlank(reqVO.getReservoirName()),
                        YzWaterReservoirDO::getReservoirName, reqVO.getReservoirName())
                .eq(StrUtil.isNotBlank(reqVO.getReservoirScale()),
                        YzWaterReservoirDO::getReservoirScale, reqVO.getReservoirScale())
