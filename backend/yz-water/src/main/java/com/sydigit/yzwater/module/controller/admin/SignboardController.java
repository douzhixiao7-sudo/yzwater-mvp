...
import com.sydigit.yzwater.module.service.signboard.SignboardExcelImportService;
...
import com.sydigit.yzwater.module.service.signboard.SignboardService;
 ...
 * 仪征管理后台 - 公示牌管理
 */
@Tag(name = "仪征管理后台 - 公示牌管理")
@RestController
@RequestMapping("/river/signboard")
@Validated
public class SignboardController {
    ...
    private final SignboardExcelImportService signboardExcelImportService;

    public SignboardController(SignboardService signboardService,
                              SignboardExcelImportService signboardExcelImportService) {
