 ...
 * 河道详情响应
 */
@Schema(description = "仪征管理后台 - 河道详情响应")
@Data
public class RiverChannelDetailRespVO {

    @Schema(description = "主键ID")
    private Long id;

    @Schema(description = "关联基础表water_facility_base.id")
    private Long facilityId;

    @Schema(description = "GeoJSON 几何")
    private String geometryGeoJson;

    @Schema(description = "几何类型")
    private String geomType;

    @Schema(description = "空间参考 ID")
    ...
    @Schema(description = "跨境类别(字典: zd_kjlb)")
    ...
    @Schema(description = "河流等级(字典: zd_hljb)")
    ...
    @Schema(description = "河道类型(多个字典值，zd_hdlx)")
    private String[] riverType;

    @Schema(description = "河道图片")
    private String[] riverPhotos;

    @Schema(description = "河道水质状况(字典: zd_hdszqk)")
    ...
    @Schema(description = "河段详情列表")
    private List<RiverSectionDetailRespVO> sections;
}
