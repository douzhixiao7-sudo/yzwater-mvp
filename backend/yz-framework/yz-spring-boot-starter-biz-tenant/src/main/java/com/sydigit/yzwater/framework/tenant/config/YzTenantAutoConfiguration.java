package com.sydigit.yzwater.framework.tenant.config;

import com.sydigit.yzwater.framework.common.biz.system.tenant.TenantCommonApi;
import com.sydigit.yzwater.framework.common.enums.WebFilterOrderEnum;
import com.sydigit.yzwater.framework.mybatis.core.util.MyBatisUtils;
import com.sydigit.yzwater.framework.redis.config.YzCacheProperties;
...
import com.sydigit.yzwater.framework.tenant.core.aop.TenantIgnoreAspect;
import com.sydigit.yzwater.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.sydigit.yzwater.framework.tenant.core.job.TenantJobAspect;
import com.sydigit.yzwater.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.sydigit.yzwater.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.sydigit.yzwater.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.sydigit.yzwater.framework.tenant.core.redis.TenantRedisCacheManager;
import com.sydigit.yzwater.framework.tenant.core.security.TenantSecurityWebFilter;
import com.sydigit.yzwater.framework.tenant.core.service.TenantFrameworkService;
import com.sydigit.yzwater.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.sydigit.yzwater.framework.tenant.core.web.TenantContextWebFilter;
import com.sydigit.yzwater.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "yz.tenant", value = "enable", matchIfMissing = true) // 允许使用 yz.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class YzTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     YzCacheProperties yzCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(yzCacheProperties.getRedisScanBatchSize()));
