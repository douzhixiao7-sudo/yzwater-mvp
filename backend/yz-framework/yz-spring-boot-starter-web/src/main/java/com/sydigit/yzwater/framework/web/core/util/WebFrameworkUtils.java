package com.sydigit.yzwater.framework.web.core.util;

import cn.hutool.core.util.NumberUtil;
import com.sydigit.yzwater.framework.common.enums.TerminalEnum;
...
public class WebFrameworkUtils {
     ...
     * 终端的 Header
     *
     * @see com.sydigit.yzwater.framework.common.enums.TerminalEnum
     */
    ...
    public static Integer getLoginUserType(HttpServletRequest request) {
        ...
        if (request.getServletPath().startsWith(properties.getAppApi().getPrefix())) {
            return UserTypeEnum.ADMIN.getValue();
            //return UserTypeEnum.MEMBER.getValue();//todo 这里不区分用户类别统一用1
        }
        return null;
    }
