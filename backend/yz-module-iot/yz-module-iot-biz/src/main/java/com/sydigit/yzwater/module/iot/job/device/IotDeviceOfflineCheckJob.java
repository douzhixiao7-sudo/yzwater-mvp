package com.sydigit.yzwater.module.iot.job.device;
...
import com.sydigit.yzwater.module.iot.framework.iot.config.YzIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private YzIotProperties iotProperties;
