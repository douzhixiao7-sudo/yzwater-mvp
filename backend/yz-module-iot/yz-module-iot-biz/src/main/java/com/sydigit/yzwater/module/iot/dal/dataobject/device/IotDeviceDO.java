...
import com.sydigit.yzwater.framework.mybatis.core.type.LongSetTypeHandler;
...
public class IotDeviceDO extends TenantBaseDO {
     ...
     * 设备图片
     */
    @TableField(value = "pic_url", jdbcType = JdbcType.ARRAY, typeHandler = StringArrayTypeHandler.class)
