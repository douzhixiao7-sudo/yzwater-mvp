package com.sydigit.yzwater.module.iot.controller.admin.product.vo.product;
...
import com.sydigit.yzwater.module.iot.enums.product.IotNetTypeEnum;
...
public class IotProductSaveReqVO {
    ...
    @Schema(description = "协议类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "http")
