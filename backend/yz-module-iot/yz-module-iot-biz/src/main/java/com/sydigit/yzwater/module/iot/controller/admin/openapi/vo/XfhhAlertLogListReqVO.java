 ...
 */
@Data
@Schema(description = "幸福河湖平台-水位报警记录查询请求")
public class XfhhAlertLogListReqVO {
     ...
     */
    @Data
    @Schema(name = "XfhhAlertLogListParams", description = "幸福河湖平台-水位报警记录查询参数")
    public static class Params {

        @Schema(description = "水位计编号", example = "1")
