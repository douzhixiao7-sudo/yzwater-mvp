package com.sydigit.yzwater.module.iot.service.rule.scene.matcher;
...
import com.sydigit.yzwater.module.iot.enums.rule.IotSceneRuleConditionTypeEnum;
import com.sydigit.yzwater.module.iot.enums.rule.IotSceneRuleTriggerTypeEnum;
import com.sydigit.yzwater.module.iot.service.rule.scene.matcher.condition.IotSceneRuleConditionMatcher;
import com.sydigit.yzwater.module.iot.service.rule.scene.matcher.trigger.IotSceneRuleTriggerMatcher;
...
public class IotSceneRuleMatcherManager {
    ...
    public boolean isMatched(IotDeviceMessage message, IotSceneRuleDO.Trigger trigger) {
        ...
        try {
          /*  log.debug("[matcher][触发器匹配器: {}]", JSONObject.toJSONString(matcher));
            log.debug("[isMatched][触发器匹配器: {}]", JSONObject.toJSONString(message));
            log.debug("[trigger][触发器匹配器: {}]", JSONObject.toJSONString(trigger));*/
