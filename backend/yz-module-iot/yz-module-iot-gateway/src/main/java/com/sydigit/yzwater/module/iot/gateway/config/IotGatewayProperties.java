...
import com.sydigit.yzwater.module.iot.gateway.protocol.genesis.IotGenesisHttpConfig;
import com.sydigit.yzwater.module.iot.gateway.protocol.mqttsource.IotMqttSourceConfig;
...
@ConfigurationProperties(prefix = "yz.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
        ...
        /**
         * GENESIS64 HTTP 主动采集配置
         */
        private IotGenesisHttpConfig genesis64Http;

        /**
         * MQTT Source 固定主题采集配置
         */
        private IotMqttSourceConfig mqttSource;
