package com.sydigit.yzwater.module.iot.core.messagebus.config;
...
import com.sydigit.yzwater.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
...
import com.sydigit.yzwater.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.sydigit.yzwater.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.sydigit.yzwater.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "yz.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "yz.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 YzRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.sydigit.yzwater.framework.mq.redis.config.YzRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "yz.iot.message-bus", name = "type", havingValue = "redis")
