package com.sydigit.yzwater.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 行政区划 1-002-029-000 ==========
    ErrorCode AREA_PARAM_INVALID = new ErrorCode(1_002_029_000, "行政区划参数不合法");
    ErrorCode AREA_NOT_EXISTS = new ErrorCode(1_002_029_001, "行政区划不存在");
    ErrorCode AREA_ID_DUPLICATE = new ErrorCode(1_002_029_002, "行政区划编码已存在");
    ErrorCode AREA_PARENT_NOT_EXISTS = new ErrorCode(1_002_029_003, "父级行政区划不存在");
    ErrorCode AREA_PARENT_ERROR = new ErrorCode(1_002_029_004, "不能设置自己为父级行政区划");
    ErrorCode AREA_EXISTS_CHILDREN = new ErrorCode(1_002_029_005, "存在子级行政区划，无法删除");
