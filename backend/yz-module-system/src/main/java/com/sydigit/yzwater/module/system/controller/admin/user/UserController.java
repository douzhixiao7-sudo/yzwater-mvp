package com.sydigit.yzwater.module.system.controller.admin.user;
...
import com.sydigit.yzwater.module.system.controller.admin.user.vo.user.*;
import com.sydigit.yzwater.module.system.convert.user.UserConvert;
...
import com.sydigit.yzwater.module.system.enums.common.SexEnum;
...
public class UserController {
    ...
    public CommonResult<List<UserSimpleRespVO>> getSimpleUserList(
            @RequestParam(value = "excludeRoleName", required = false) String excludeRoleName) {
        List<AdminUserDO> list;
        if (StrUtil.isNotBlank(excludeRoleName)) {
            List<String> excludeRoleNames = Arrays.stream(excludeRoleName.split(","))
                    .map(String::trim)
                    .filter(StrUtil::isNotBlank)
                    .collect(Collectors.toList());
            list = userService.getUserListByStatusExcludeRoleNames(CommonStatusEnum.ENABLE.getStatus(), excludeRoleNames);
        } else {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunai@iocoder.cn").mobile("15601691300")
                        .nickname("lijun").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
