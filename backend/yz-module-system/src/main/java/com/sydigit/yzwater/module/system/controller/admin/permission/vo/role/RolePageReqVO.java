package com.sydigit.yzwater.module.system.controller.admin.permission.vo.role;
...
public class RolePageReqVO extends PageParam {
    ...
    @Schema(description = "角色名称，模糊匹配", example = "lijun")
    private String name;

    @Schema(description = "角色标识，模糊匹配", example = "yz")
    private String code;
