...
import com.sydigit.yzwater.module.system.controller.admin.dict.vo.data.DictDataRespVO;
import com.sydigit.yzwater.module.system.controller.admin.dict.vo.data.DictDataSaveReqVO;
import com.sydigit.yzwater.module.system.controller.admin.dict.vo.data.DictDataSimpleRespVO;
...
public class DictDataController {
    ...
    @PermitAll
    @Parameter(name = "dictType", description = "字典类型", required = true, example = "common_status")
    public CommonResult<List<DictDataSimpleRespVO>> getDictDataListByType(@RequestParam("dictType") String dictType) {
