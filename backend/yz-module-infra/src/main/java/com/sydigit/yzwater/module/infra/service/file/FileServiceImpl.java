...
import com.sydigit.yzwater.module.infra.controller.admin.file.vo.file.FileCreateReqVO;
import com.sydigit.yzwater.module.infra.controller.admin.file.vo.file.FilePageReqVO;
import com.sydigit.yzwater.module.infra.controller.admin.file.vo.file.FilePresignedUrlRespVO;
import com.sydigit.yzwater.module.infra.dal.dataobject.file.FileDO;
import com.sydigit.yzwater.module.infra.dal.mysql.file.FileMapper;
import com.sydigit.yzwater.module.infra.framework.file.core.client.FileClient;
import com.sydigit.yzwater.module.infra.framework.file.core.utils.FileTypeUtils;
...
import static com.sydigit.yzwater.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
...
public class FileServiceImpl implements FileService {
    ...
    public void deleteFileByUrl(String url) throws Exception {
        ...
        FileDO file = fileMapper.selectOne(FileDO::getUrl, normalizedUrl);
        if (file == null && StrUtil.isNotBlank(url) && !StrUtil.equals(url, normalizedUrl)) {
            file = fileMapper.selectOne(FileDO::getUrl, url);
        }
        if (file == null) {
