package com.sydigit.yzwater.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.sydigit.yzwater.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.sydigit.yzwater.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "lijun，牛逼！")
    @ExcelProperty("结果提示")
