...
import com.sydigit.yzwater.module.infra.controller.admin.file.vo.file.*;
import com.sydigit.yzwater.module.infra.dal.dataobject.file.FileDO;
import com.sydigit.yzwater.module.infra.service.file.FileService;
...
public class FileController {
   ...
   // @PreAuthorize("@ss.hasPermission('infra:file:delete')")
    ...
    @Operation(summary = "根据文件访问地址删除文件")
    @Parameter(name = "url", description = "文件访问地址", required = true)
