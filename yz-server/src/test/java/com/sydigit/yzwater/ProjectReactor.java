...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.sydigit.yz";
    private static final String ARTIFACT_ID = "yz";
    private static final String PACKAGE_NAME = "com.sydigit.yzwater";
    private static final String TITLE = "仪征河道管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.sydigit.yz";
        String artifactIdNew = "yz";
        String packageNameNew = "com.sydigit.yzwater";
        String titleNew = "仪征河道管理系统";
        String projectBaseDirNew = "D:\\code\\RuoYi-Vue-Dev\\yzwater"; // 一键改名后，“新”项目所在的目录
