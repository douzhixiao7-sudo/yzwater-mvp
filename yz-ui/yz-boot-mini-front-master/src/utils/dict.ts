...
export enum DICT_TYPE {
  ...
  IOT_DEVICE_USE_STATUS = 'iot_device_use_status', // IOT 设备使用状态
  IOT_DEVICE_TYPE = 'iot_deivce_type', // IoT 设备分类
  IOT_DEVICE_FAULT_STATUS = 'iot_deivce_fault_status', // IoT 设备故障状态
  IOT_DEVICE_FAULT_TYPE = 'iot_deivce_fault_type', // IoT 设备故障类型
  IOT_WATER_ENGINEERING = 'iot_water_engineering', // IoT 涉及工程
  IOT_DEVICE_DOC_TYPE = 'iot_deivce_doc_type', // IoT 设备资料类型
  IOT_DEVICE_RATING = 'iot_device_rating', // IoT 设备评级标准
  IOT_DEVICE_ACCIDENT_TYPE = 'iot_device_accident_type', // IoT 设备事故类型
  IOT_THING_MODEL_TYPE = 'iot_thing_model_type', // IOT 产品功能类型
  IOT_THING_MODEL_UNIT = 'iot_thing_model_unit', // IOT 物模型单位
  IOT_RW_TYPE = 'iot_rw_type', // IOT 读写类型
  ZD_SSLB = 'zd_sslb', // 所属类别
  IOT_ZD_SBZD = 'iot_zd_sbzd', // IoT 所属站点
  IOT_SPARE_TYPE = 'iot_spare_type', // IoT 备件类型
  IOT_SPARE_STORAGE_LOCATION = 'iot_spare_storage_location', // IoT 备件存放位置
  IOT_SPARE_IO_TYPE = 'iot_spare_io_type', // IoT 备件出入库类型
  IOT_SPARE_IO_AUDIT_STATUS = 'iot_spare_io_audit_status', // IoT 备件出入库审核状态
  IOT_SPARE_USAGE_TYPE = 'iot_spare_usage_type', // IoT 备件出库用途类型
  IOT_SPARE_CHECK_RESULT = 'iot_spare_check_result', // IoT 备件盘点结果
  IOT_MAINTENANCE_TYPE = 'iot_maintenance_type', // IoT 养护类型
  IOT_INSPECTION_TYPE = 'iot_inspection_type', // IoT 巡检类型
  IOT_INSPECTION_PERIOD = 'iot_inspection_period', // IoT 巡检周期
  IOT_INSPECTION_LINE_AREA = 'iot_inspection_line_area', // IoT 巡检线路适用区域
