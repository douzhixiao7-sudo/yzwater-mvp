  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="协议类型" prop="protocolType">
        ...
        >
          <el-option
            v-for="dict in getStrDictOptions(protocolDictType)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="序列化类型" prop="codecType">
...
const formRules = reactive({
  ...
  netType: [{ required: true, message: '联网方式不能为空', trigger: 'change' }],
  protocolType: [{ required: true, message: '协议类型不能为空', trigger: 'change' }],
  codecType: [{ required: true, message: '序列化类型不能为空', trigger: 'change' }]
})
const formRef = ref()
