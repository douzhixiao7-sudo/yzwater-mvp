package com.sydigit.yzwater.framework.jackson.config;

import com.sydigit.yzwater.framework.common.util.json.JsonUtils;
import com.sydigit.yzwater.framework.common.util.json.databind.NumberSerializer;
import com.sydigit.yzwater.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.sydigit.yzwater.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class YzJacksonAutoConfiguration {
