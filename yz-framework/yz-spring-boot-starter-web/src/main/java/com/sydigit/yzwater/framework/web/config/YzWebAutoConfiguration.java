package com.sydigit.yzwater.framework.web.config;
...
import com.sydigit.yzwater.framework.web.core.filter.CacheRequestBodyFilter;
import com.sydigit.yzwater.framework.web.core.filter.DemoFilter;
import com.sydigit.yzwater.framework.web.core.handler.GlobalExceptionHandler;
import com.sydigit.yzwater.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class YzWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "yz.demo", havingValue = "true")
