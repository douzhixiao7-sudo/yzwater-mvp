...
import com.sydigit.yzwater.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "yz.tracer", value = "enable", matchIfMissing = true)
public class YzTracerAutoConfiguration {
