...
public class SignboardExcelImportService {
    ...
    private Set<String> initExistingSignboardCodes() {
        List<YzSignboardDO> signboards = signboardMapper.selectList(new LambdaQueryWrapper<YzSignboardDO>()
                .select(YzSignboardDO::getSignboardCode)
                .isNotNull(YzSignboardDO::getSignboardCode));
        Set<String> result = new HashSet<>();
        for (YzSignboardDO item : signboards) {
            if (item == null) {
                continue;
            }
    ...
    private FacilityContext initFacilityContext() {
        ...
        List<YzRiverChannelDO> riverChannels = riverChannelMapper.selectList(new LambdaQueryWrapper<YzRiverChannelDO>()
                ...
                .isNotNull(YzRiverChannelDO::getRiverName)
                .orderByAsc(YzRiverChannelDO::getId));
        for (YzRiverChannelDO item : riverChannels) {
        ...
        List<YzWaterReservoirDO> reservoirs = waterReservoirMapper.selectList(new LambdaQueryWrapper<YzWaterReservoirDO>()
                ...
                .isNotNull(YzWaterReservoirDO::getReservoirName)
